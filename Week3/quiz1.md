...
- 답: Working Directory, Staging Area, Git Directory
...
- 답: Create a merge commit : 두 브랜치를 공통 부모로 하는 새로운 commit을 만듦 <br/>
...
- 답: commit hash - a1s2d3f<br/>     branch - develop<br/>      commit message - docs: readme 추가
...
- 답: reset은 commit을 삭제하므로 commit을 공유하는 다른 branch에 영향을 줄수 있다. 따라서 안정성을 위하여 revert를 사용할 것이다.
